            ...
            {sortedHoldings.map((h, i) => (
              <tr key={h.id} className="hover:bg-slate-50/80 transition-colors">
                <td className="py-3.5 px-3">
                  <span className="font-mono text-slate-400 font-bold text-xs">#{i + 1}</span>
                </td>
                <td className="py-3.5 px-3">
                ...
                <td className="py-3.5 px-3 font-mono font-bold text-slate-900">Rp {formatNumber(h.currentPrice)}</td>
                ...
                <td className="py-3.5 px-3">
                  <div className="flex items-center gap-2 mb-1">{getStatusBadge(h.actionStatus)}</div>
                  <p className="text-[11px] text-slate-600 leading-snug max-w-sm">{h.actionReason}</p>
                </td>
